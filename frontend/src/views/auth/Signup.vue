      ...
      <tiles>
        <card-component title="New Employee" icon="account-edit" class="tile is-child">
          <form @submit.prevent="submit">
            <b-field label="Your Employee ID" horizontal>
              <b-input v-model="form.id" custom-class="is-static" readonly />
            </b-field>
            <hr>
            <b-field label="First Name" message="Your first name" horizontal>
              <b-input placeholder="John" v-model="firstname" required />
            </b-field>
            <b-field label="Last Name" message="Your last name" horizontal>
              <b-input placeholder="Doe" v-model="lastname" required />
            </b-field>
            <b-field label="Username" message="Your prefered username" horizontal>
              <b-input placeholder="Will Smith" v-model="username" required />
            </b-field>
           <hr>
           <b-field>
            ...
            <b-field label="Confirm Your Password" message="Your password again" horizontal>
              <b-input placeholder="Will@Smith2020" v-model="password_confirm" required />
            </b-field>
           </b-field>
           <hr>
            ...
            <b-field label="Role" message="Your Role" horizontal>
              <b-select placeholder="What is your role in this company?" v-model="role" required>
              <option v-for="(roles, index) in roles" :key="index" :value="roles">
                {{ roles }}
              </option>
            </b-select>
            </b-field>
            <b-field label="Phone Number" message="Your phone number" v-model="phone_number" horizontal>
              <b-field>
              <p class="control">
            ...
            <b-field label="Date Of Birth" v-model="date_of_birth" horizontal>
              <b-datepicker
                @input="input"
            ...
            <hr>
            <b-field label="Choose an Avatar" horizontal>
              <file-picker/>
            </b-field>
            <hr>
            <b-field horizontal>
